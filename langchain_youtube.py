...
def main():
    ...
    st.title("Health Transcript Chatbot")
    
    # FULL VIDEO AT: https://youtu.be/-dmJSLNgjxo
    # PULLED INFO AT: https://youtu.be/-dmJSLNgjxo?si=cne7DRct671sNMjX&t=198
    # What is at the core of public health?
